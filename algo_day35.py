...
# 불의의 교통사고를 당한 당신은 얼마 후 
# 자신의 인식 속에서 모음이라는 것이 사라진 것을 알게 되었다.
...
# 각 테스트 케이스의 첫 번째 줄에는 길이가 50이하이고 
...
for t in range(int(input())):
    # 입력받은 문자를 한 글자씩 불러와서 aeiou면 제외하고 남기기
    print(f"#{t+1}", ''.join(w for w in input() if w not in 'aeiou'))
